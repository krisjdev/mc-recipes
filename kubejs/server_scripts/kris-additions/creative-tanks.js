...
ServerEvents.recipes(event => {
    ...
    for (var key in block_dict) {
        ...
        var block_tag = "kubejs:block_of_" + key.toString().toLowerCase()
        ...
        var nbt = '{mekData:{GasTanks:[{Tank:0b,stored:{amount:9223372036854775806.999,gasName:"' + value.gas_input + '"}}]}}'

        // creative chemical tank variants
        event.custom({
            ...
            ingredients: [
                ...
                result: Item.of("mekanism:creative_chemical_tank", nbt)
            })      
    }
})